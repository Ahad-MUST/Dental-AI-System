# speechbrain_engine.py - Optimized SpeechBrain Speaker Diarization Engine (Suppressed Logs)
...
# Suppress SpeechBrain specific loggers
...
logging.getLogger("speechbrain.dataio.encoder").setLevel(logging.ERROR)
logging.getLogger("speechbrain.pretrained").setLevel(logging.ERROR)
...
class SpeechBrainEngine:
    ...
    def _initialize_models(self):
        """Initialize SpeechBrain models with suppressed output"""
        try:
            ...
            # Create null devices to suppress output
            ...
            if self.vad_model is None:
                print("SpeechBrain models loaded successfully (VAD: energy-based)")
            else:
                print("SpeechBrain models loaded successfully (VAD: neural)")
